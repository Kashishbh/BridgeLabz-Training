...
public class EmployeeSalaryCategorization {
    ...
    public static void main(String[] args) {
        List<Employee> employees = Arrays.asList(
                new Employee("Ron", "HR", 60000),
                new Employee("Asmita", "Engineering", 90000),
                new Employee("Kiona", "HR", 65000),
                new Employee("Kaira", "Engineering", 95000),
                new Employee("Anton", "Sales", 70000),
                new Employee("Ammy", "Engineering", 85000)
        );
