        ...
        while (true) {
            ...
            if (command.equals("ADD_FESTIVAL")) {
                ...
                if (type.equals("MUSIC")) {
                    ...
                    festivals.put(name,
                            new MusicFestival(name, location, date, headliner, genre, price));
                    ...
                    festivals.put(name,
                            new FoodFestival(name, location, date, cuisine, stalls, fee));
                    ...
                    int fee= sc.nextInt();
                    festivals.put(name,
                            new ArtFestival(name,location,date,artType,artists,fee));
                }
